    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType) {
            case Sensor.TYPE_LIGHT:
                txtBrightnessInfo.setText(getResources().getString(R.string.label_brightness));
                //graph view
                graphLastAccelValue += 0.15d;
                mSeriesLight.appendData(new DataPoint(graphLastAccelValue, sensorEvent.values[0]),
                        true, 33);
